...
?>
<!-- Modal Bootstrap 4 -->
<div class="modal fade" id="modalRegistrarVerificacion" tabindex="-1" role="dialog" aria-labelledby="modalRegistrarVerificacionLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="modalRegistrarVerificacionLabel"><i class="fas fa-file-alt"></i> Registrar Verificación</h5>
      ...
      <div class="modal-body">
        ...
        <form id="registrarVerificacionForm" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <select name="acta_id" id="acta_id" class="form-control" required>
          ...
          <div class="form-group">
            ...
            <input type="date" name="fecha_verificacion" id="fecha_verificacion" class="form-control" required>
          </div>

          <!-- Archivo de Verificación -->
          <div class="form-group">
            <label for="archivo_verificacion">Archivo de Verificación (PDF):</label>
            <input type="file" name="archivo_verificacion" id="archivo_verificacion" class="form-control-file" accept=".pdf">
...
<script>
  $(document).ready(function() {
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              if (response.status === "success") {
                ...
                $('#modalRegistrarVerificacion').modal('hide'); // Cerrar modal
              } else {
                Swal.fire({
                  icon: 'error',
                  title: 'Error',
    ...
    $("#archivo_verificacion").on("change", function() {
