...
<div class="modal fade" id="modalRegistrarJunta" tabindex="-1" role="dialog" aria-labelledby="modalRegistrarJuntaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-users"></i> Registrar Junta Directiva</h5>
                    ...
                    <table class="table table-bordered mt-3" id="tabla-miembros">
                        ...
                        <tbody>
                            <tr id="fila_1">
                                ...
                                <td><button type="button" class="btn btn-danger btn-sm" onclick="eliminarFila(1)"><i class="fas fa-trash-alt"></i></button></td>
                            </tr>
                        </tbody>
                    </table>
