...
<div class="container">
    <h2><i class="fas fa-cogs"></i> Listado de Categorías</h2>
...
// Función para eliminar categoría con SweetAlert2
function confirmarEliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("modules/categoria/eliminar_categoria.php", { id: id }, function() {
