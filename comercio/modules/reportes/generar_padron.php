...
class PDF extends FPDF {
    ...
    function Header() {
        if ($this->PageNo() == 1) {
            ...
            $this->SetX($this->lMargin); // Asegura que empieza desde el margen izquierdo
        ...
        $this->SetWidths([
            $totalWidth * 0.04, // Nº
            $totalWidth * 0.08, // DNI
            $totalWidth * 0.26, // APELLIDOS
            $totalWidth * 0.22, // NOMBRES
            $totalWidth * 0.26, // SUBRUBRO
            $totalWidth * 0.14  // ESTADO
        ]);
        ...
        $this->Cell($this->widths[5], 8, utf8_decode('ESTADO'), 1, 0, 'C');
        $this->Ln();
    }
