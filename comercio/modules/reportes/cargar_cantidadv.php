    ...
    $data[] = [
        ...
        "padron" => '
            <div style="white-space: nowrap;">
                <a href="modules/reportes/generar_padron.php?idgrupo=' . $row['idgrupo'] . '" target="_blank" class="btn btn-sm btn-danger mx-1" title="Exportar PDF">
                    <i class="fas fa-file-pdf"></i>
                </a>
                <a href="modules/reportes/generar_excel.php?idgrupo=' . $row['idgrupo'] . '" class="btn btn-sm btn-success mx-1" title="Exportar Excel">
